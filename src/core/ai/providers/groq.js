...
var GroqProvider = /** @class */ (function (_super) {
    __extends(GroqProvider, _super);
    function GroqProvider() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.id = 'groq';
        _this.name = 'Groq Cloud';
        return _this;
    }
    GroqProvider.prototype.getDefaultModel = function () {
        return 'llama3-70b-8192';
    };
    GroqProvider.prototype.getVisionModel = function () {
        return 'llama-3.2-90b-vision-preview';
    };
    GroqProvider.prototype.listModels = function () {
        return GROQ_MODELS;
    };
    GroqProvider.prototype.generateVisionAnalysis = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 3:
                        errStr = _j.sent();
                        throw new Error("Groq API Error: ".concat(res.status, " ").concat(errStr));
                    ...
                    case 6:
                        err_1 = _j.sent();
                        throw new Error("Groq API Failed: ".concat(err_1.message));
