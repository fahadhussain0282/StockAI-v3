...
var TokenService = /** @class */ (function () {
     ...
     */
    TokenService.generateSessionToken = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var randomHex;
            return __generator(this, function (_a) {
                randomHex = crypto.randomBytes(8).toString('hex');
                return [2 /*return*/, "tok_".concat(Date.now(), "_").concat(randomHex)];
            });
        });
    };
    /**
    ...
    TokenService.validateTokenFormat = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, token.startsWith('tok_') && token.length > 10];
            });
        });
    };
    return TokenService;
