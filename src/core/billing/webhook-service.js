...
var WebhookService = /** @class */ (function () {
    ...
    WebhookService.handleProviderWebhook = function (provider, payload, signature) {
        return __awaiter(this, void 0, void 0, function () {
            var eventType;
            return __generator(this, function (_a) {
                // 1. Validate signature using the corresponding Provider class
                console.log("[WebhookService] Received ".concat(provider, " webhook."));
                ...
                switch (eventType) {
                    ...
                    case 'payment_intent.succeeded':
                        ...
                        break;
                    default:
                        console.log("[WebhookService] Unhandled event type: ".concat(eventType));
                }
                return [2 /*return*/];
            });
        });
